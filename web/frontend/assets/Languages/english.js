const english = {
    ...
    reportPage: "Reports",
    paidPlans: "Change Plan",
    getSupport: "Get Support",
    emailReportsPage: "Email Report",

    // ---------------------common text---------------------
    save: "Save",
    loadingText: "Loading...",
    noRecordFound: "No record found",
    swalHeading: "Successfully Updated",
    swalText: "Your custom settings updated successfully on your site",
    swalOk: "OK",
    swalWaiting: "Please wait for a while...",
    swalDeleteHeading: "Are you sure?",
    swalDeleteText: "You want to delete it!",
    swalDeleteConfirm: "Yes, Delete it!",
    swalButtonCancelText: "Cancel",
    buttonSetting: "Button Settings",
    textSetting: "Text Settings",
    paddingTopAndBottom: "Padding (Top & Bottom)",
    ...
    planPaid1: "Your ",
    planPaid2: " plan started on ",
    planPaid3: " and will expire on ",

    changePlan: "Change Plan",
    themeSetup: "Get Support",
    ...
    outofStockTEXT: "Button text for out of stock",

    quickAccessHeading: "Quick Access Links",
    quickAccessText: "Below are few helpful shortcut links to navigate to important pages easily",
    ...
    enabletheme: "Activate app",
    disabletheme: "Switch theme",

    enableCollectionIcon: "Enable icon",
    disableCollectionIcon: "Disable icon",
    ...
    amount: "Amount:",
    monthlyQuotaHeading: "Monthly Quota",
    monthlyQuotaText: " monthly Quota is used",
    ...
    sddOpenCalander: "Open calendar ",
    sddSubmitDate: "Submit Date",
    viewAll: "View all",
    totalusers: "users",
    totalitems: "items",
    ...
    revenuesearch: "Searching in all",
    emailValue: "email",
    ...
    hover: "Hover",
    active: "Active",
    cartChecked: "If you want to add custom styles on Move to Cart button then please check the following check box otherwise default styles will be applied.",

    // --------------------------style update--------------------------

    styleBackgroundColor: "Pick a color for the Background",
    styleTextColor: "Text Color",
    styleFontSize: "Font Size",
    styleFontFamily: "Font Family (shopify default font family works only)",
    styleBorderRadius: "Border Radius",
    stylePadding: "Padding",
    styleMargin: "Margin",
    styleWidth: "Width",
    styleBorder: "Border",
    styleTextAlign: "Text Align",
    styleHover: "Hover",
    styleHoverYes: "Yes",
    styleHoverNo: "No",
    styleHoverBG: "Background color",
    styleHoverText: "Text color",
    styleHoverBorder: "Border",

    // --------------------languageSetting--------------------
    languageSub: "Multi language support and native language options for the admin side and for the front side",
    lanuageEditName: "Edit Settings",
    languageMultiHead: "Multi Language Support",
    languageMultitext: "Multi lanaguage support for the text messages",
    languageOptionHead: "Native Language Options (Admin side only)",
    languageOptionText: "Select the language for the your admin side",
    ...
    swveHeading7: "Heading for recipients email field",
    swveHeading8: "Heading for message field",
    ...
    customCssText: "Customize css for your site ( Use !important with every css property )",
    customCssPlaceholder: "Enter here custom css for your site...",

    customJsHeading: "Custom javascript/jQuery",
    customJsText: `Customize javascript/jQuery for your site (use "" only)`,
    ...
    wishlistUIStyleTextColor: "Pick a color for the Text",
    wishlistUIStylePadding: "Padding",
    wishlistUIStyleTextAlign: "Text align",
    ...
    iconLocationValue3Heading: "Choose type of floating icon --- ",
    iconLocationValue3Sub1: "Bottom Right",
    ...
    ilhIconColor: "Color for icon",
    ilhIconHeight: "Height for icon",
    ilhIconWidth: "Width for icon",

    iconLocationShap: "Select shape for floating icon background",
    iconLocationSquare: "Square",
    iconLocationCircle: "Circle",
    ...
    iconCustomCodeExampleYes: "Yes",
    iconCustomCodeExampleNo: "No",
    ...
    subNotificationValue2Sub2: "Bottom Left of the screen",
    subNotificationValue2Sub3: "Bottom Right of the screen",
    subNotificationValue2Sub4: "Top center of the screen",
    subNotificationValue2Sub5: "Top left of the screen",
    ...
    // tableViewDetail: "View detail",
    tableDelete: "Delete",

    // --------------------planPage--------------------
    planPageMainHeading: "Paid Subscription",
    planPageMainText: "Here you can choose the paid plans for more features of your site",


    monthly: "Monthy",
    yearly: "Yearly",
    discount: "Save 17%",
    yearlySub: "on yearly subscription",

    intrestedText: "Intrested to know about our",
    ...
    floatingIconPosition: "Select floating icon position",
    ...
    cpDeveloperDocs: "Developer-Docs",

    cpRequestForm: "Request Form",

    cpSubject: "Subject",
    cpSubjectSelect: "Please select the option",
    cpSubjectSelect1: "Theme setup",
    cpSubjectSelect2: "Customization",
    cpSubjectSelect3: "Feedback",
    cpSubjectSelect4: "Other",

    cpMessage: "Message",
    cpMessagePlaceholder: "Please setup the app on my store",

    cpErrorMsg: "This field is required",

    cpSubmit: "Submit",

    cpPostButton: "Post a Quick Review",
    ...
    collectionIconSelectedBgColor: "Icon selected Background color",
    collectionIconDefaultBgColor: "Icon default Background color",
    ...
    textSettingSubHeading: "Here you can customize button's text styles",
    iconSettingSubHeading: "Here you can customize button's icon styles",
    buttonSettingSubHeading: "Here you can customize button's styles",
    notificationButtonSetting: "Notification Settings",
    notificationButtonSettingSubHeading: "Here you can customize notification's styles",
    notificationTextSetting: "Notification Text Settings",
    notificationTextSettingSubHeading: "Here you can customize notification's text styles",
    ...
    previewProductColor: "Color",
    ppcValue1: "Red",
    ppcValue2: "Blue",
    ppcValue3: "Black",
    selectDateForData: "Select date",
    ...
    userWishlistCount: "Item Counts",
    userAddToCartCount: "Cart Counts",


    // ------------------------------------------------------------------------------------


    supportHeading: "Need Assistance with App Setup or Customization?",
    supportSubText: "We understand sometimes this can look cumbersome to configure app on your own, Don't worry we are here to help you out with all heavy lifting. We can install and configure the app properly on your store and make necessary adjustments as per your needs. Reach out to us for expert guidance and take your app experience to the next level! (It's a FREE service) ❤️",
    supportBtn: "Contact Support Team",

    cpPostHeading: "We are here to help",
    cpPostText: "When you have a question, just drop us an email at",
    cpPostText2: "and our team will get in touch with you as soon as possible. (Please mention store URL in the email)",
    ...
    // -------------------------------------------------------------------------------------
    collectionIconQuickAsIcon: "As a icon",
    collectionIconQuickAsButton: "As a button",
    collectionIconCollectionTypeAsIcon: "Icon",
    collectionIconCollectionTypeAsButton: "Button",

    collectionIconQuickAsButtonAboveCart: "Show above add to cart",
    collectionIconQuickAsButtonBelowCart: "Show  below add to cart",

    collectionIconQuickAsRightIconPosition: "Right Icon Position",
    collectionIconQuickAsLeftIconPosition: "Left Icon Position",
    collectionIconQuickAsCenterIconPosition: "Center Icon Position",

    collectionButtonNote: "All the button styles will be applied from ",
    collectionButtonNote2: "button setting",
    collectionIconPositionHeading: "Icon position on image",

    collectionIconPositionTitleHeading: "Icon position around title",
    collectionIconCartHeading: "Icon position around add to cart button",
    collectionIconCartPositionHeading: "Cart icon position",
    ...
    collectionIconAsIcon: "Customize all styles and heart icon style from below.",
    collectionIconAsButton: "You can customize button appearance from button settings page",

    collectionIconQuickViewHeading: "Quick modal settings",
    collectionIconQuickViewSubHeading: "You can configure all settings related to Quick Modal from here ",
    collectionIconClickHere: "Click Here",


    youtubeVideoHeading1: "Step 1: Activate and start app",
    youtubeVideoText1: "Please watch this two minute video to learn how you can activate the app and start using it on your store.",
    ...
    enableBlockButton: "Please.. enable the block button first !!",
    enableButtonText: "Enable",

    appCurrentlyWorkingOnTheme1: "App currently working on",
    appCurrentlyWorkingOnTheme2: "theme",

    cpRadio1: "Top Left",
    cpRadio2: "Top Right",
    cpRadio3: "Bottom Left",
    cpRadio4: "Bottom Right",
    cpRadio5: "Icon after Title",
    automaticButtontext: "Automatic",
    ...
    noSearchFoundForModal: "No match found text for search bar",
    poweredByTextForModal: "Powered by text for modal",
    quantityTextHeading: "Heading for Quantity box",
    helpingNoteForIcon: `You will need to replace  product-id="{{ product.id }}" with your theme product id variable used on your respective page.`,
    ...
    manageLanguagehd: "Manage your store front languages",
    addBtn: "Add language",
    urlValue: "Public Url",
    languageName: "Language",
    actions: "Actions",
    langModalHd: "Choose a language",
    updateLangModalHd: "Update a language",
    langModalHdSubheading: "Choose and configure the languages in which you wish to translate your store's content",
    saveBtn: "Add language",
    updateBtn: "save",
    urlTypeHd: "Domain URL type",
    selectLangHd: "Select Language",
    editTranslations: "Edit Translations",
    errorValue: "Error",
    selectAllFields: "Please select all the fields",
    chooseDifferentLang: "Please choose a different URL",
    selectBottomText: "If your language is not in this list then Please send us email at: support@webframez.com",
    selectBottomText2: "We will get back to you ASAP and will try to add that language in next 5 to 7 days",
    langUpgrade: "Upgrade to premium plan",
    langNoteText: "This feature is only available in premium plan",
    saleTextHeading: "Sale text for items",
    ...
    uploadHeading: "Upload your store's logo",
    uploadSubHeading: "You can upload your store's logo here",
    imageErrorText: "The image format must be .jpeg, .jpg, or .png.",
    imageSize: "The image size should be 1 MB or less.",
    imageSizeError: "The image size must be less than or equal to 1 MB.",

    cpEmail: "Email your email",
    cpEmailPlaceholder: "Enter your email",
    enterValidEmail: "Please enter a valid email",

    customJsItemLoadedHeading: "Custom js/jQuery after items loaded in modal, page and drawer",
    customJsItemLoadedText: `Customize js/jQuery after items loaded in modal, page and drawer (use "" only)`,
    customJsItemLoadedPlaceholder: "Enter here custom js/jQuery that you want to run after items are loaded in modal, page and drawer",

    tempHeading: "Manage email templates",
    editTemp: "Email template",
    editTempBtn: "Edit template",
    editorHeading: "Customise your email template",
    editorUpdateBtn: "Update",
    tokenHeading: "Tokens",
    tokenSubHeading: "These tokens will be replaced with dynamic data in your email",
    CustomerToken: "{Customer Email}",
    CustomerTokenValue: "This token will be replaced with the customer's email",
    ProductTitleToken: "{Product Title}",
    ProductTitleTokenValue: "This token will be replaced with the product title",
    DomainToken: "{Your Shop Domain}",
    DomainTokenValue: "This token will be replaced with your Shopify domain",
    ProductToken: "{Product Grid}",
    ProductTokenValue: "This token will be replaced with Product detail(image, price, title, etc.)",
    LogoToken: "{Logo}",
    ...
    footerSubheading: "You can change the footer content of your email and choose whether or not to display a logo in the footer",
    emailContentSubheading: "Here, you can change the body content of your email",
    emailContentSubheading: "Here, you can change the subject of your email",
    editTempSubHeading: "Here, you can customize your emails by changing the content, subject, and adding styles",
    emailSubjectSubHeading: "Please enter the subject for your email",
    colorHeading: "Email colors",
    colorSubHeading: "Here, you can choose colors for the email header, footer, text, and background",
    ...
    emailReportsSubHeading: "Here you can find detailed report of emails sent to your customers",
    ...
    clicks: "Clicks",
    emails: "Total emails",
    swalDeleteTextReset: "You will lose all your customized content and styles and revert to the default template.",
    swalDeleteConfirmReset: "Yes! Reset",
    resetBtn: "Reset",
    reportUpgradeHeading: "This feature is only available in the premium plan. Please upgrade your plan",
    ...
    announcementValue5: "Email Report Update",
    announcementSubValue5: "We added a report to track all emails sent to users from your store. Now you can check this report and also get to know how many users actually clicked through these Email alerts. You will find Email reports option from left sidebar menu.",
    ...
    afHeading: "Looking for advanced features?",
    afText: "If you can't find the customization option we                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   need within this app, we're here to help. Our team can provide bespoke solution to ensure the app meets all your business requirements.",
    afTalkToExpert: "Talk to Experts",
    afCustomDocument: "Advanced Customization Document",

    backInStockHeading: "Back in stock email reminder option",
    lowInStockHeading: "Low in stock email reminder option",
    priceDropHeading: "Price drop email reminder option",
    ...
    HideViewAs: "Hide view as label",
    HideGrid: "Hide grid option",
    ...
    shareWishlistRecieverName: "Heading for reciever name field",
    ...
    swveHeadingPlaceholder: "Placeholder text for the message field in share modal",
    // --------------------------------
    countBtnSetting1: "Increase and decrease",
    countBtnSetting2: "Increase and disable",
    countBtnSetting3: "Off",

    // ----------promo code-----------

    enterPromoCode: "Enter Promo Code",
    epcPlaceholder: "Enter your promo code",
    epcAdd: "Add",
    epcSkip: "Skip",
    epcValidation: "Please enter a promo code!",

    pcSkippedHeading: "Promo Code Skipped",
    pcSkippedSubHeading: "You chose to skip the promo code.",

    proceedPayment: "Proceed to payment",

    ipcHeading: "Invalid Promo Code!",
    ipcSubHeading: "Your promo code is invalid or expired",
    tryAnotherPc: "Try other promo code",

    pcAddedHeading: "Promo Code Added!",
    ...
    statsTab2H1: "Referred Users Detail: Referred User's wishlist items",
    statsSubHeading: "Here you can see detailed report of referred users and their wishlist items",
    statsReportHeading: "Referred users",
    statsReportHeadingSubHeadig: "Check out our referred User's Report here",
    statsItemsHeading: "Referred user's wishlist item",
    statsItemsHeadingSubHeading: "Check the wishlist items added by referred users to see what they’ve saved!",

    announcementValue8: "Referral Feature: Track and Analyze Wishlist Shares",
    announcementSubValue8: "The Wishlist Referral Feature offers a comprehensive view of how your wishlist is shared and its impact on user acquisition. It provides detailed insights into the sharing methods used—such as email, social media, or direct links—and shows how many new users have joined through referrals.",

    overValueB16: "Klaviyo",
    overValue16: "Send personalized campaigns and flows based on the customer journey using reminder event data.",
    ...
    trendingSubHeading: "Highlight the most-wished-for items in your marketing strategy by promoting them as upsell opportunities, motivating customers to complete their purchase and increasing sales.",
    selectProductsHeading: "Select Products",
    selectProductsSubHeading: "Choose the products to display in the trending widget",
    gridView: "Display as grid",
    sliderView: "Display as slider",
    topProducts: "Show customer's favourite products",
    recentlyProducts: "Show recently wishlist products",
    randomProducts: "Show random products",
    layoutView: "Layout styles",
    layoutViewPara: "Explore various styles for the Trending Wishlist widget to make it more visually appealing and engaging.",
    autoRotationText: "Auto-rotation for sliders",
    navigationArrowsText: "Show slider navigation arrows",
    navigationDotsText: "Show navigation dots",
    desktopProducts: "Products per row on desktop",
    mobileProducts: "Products per row on mobile",
    trendingSectionHeading: "Section Heading",
    trendingShortCodeHeading: "Trending widget short code",
    trendingShortCodeSubHeading: "Place the Trending Widget section anywhere you like using this shortcode, giving you complete flexibility in design and placement.",

    addProductButtonText: "Add product button text",
    trendingNoteText: "Navigation arrows, dots, and auto-rotation functionality in the slider will not work if the number of products per row exceeds the number of products in the trending widget section.",
    trendingHeading: "Trending Widget",

    klaviyoAnnouncement: "We’re excited to offer Klaviyo to help you track wishlist activity and improve customer engagement. With this integration, you can gain valuable insights into your customers’ preferences and behavior. Use Klaviyo to enhance your marketing efforts, create personalized campaigns, and drive better results!",
    klaviyoNote: "For detailed guidance on Klaviyo settings and setup, please visit our documentation.",



    // -------------new fields for smtp------------

    smtpHeading: "SMTP setting for email reminder",
    smtpSubHeading: "Configure the SMTP for the email reminders",
    smtpLabel1: "Sender name",
    smtpLabel2: "From email",
    ...
    pdpImageIconSubHeading: "Choose the perfect position to match your store's layout.",
    pdpNoteForIconCustomization: "You can customise icon appearance from the Collection Setting page",

    pdpTitleIconHeading: "Display Wishlist Icon Beside 'the Product Title' on the Product Page",
    pdpLeftSideOfTitle: "Left side of the title",
    pdpRightSideOfTitle: "Right side of the title",

    pdpAddToCartIconHeading: "Display Wishlist Icon Beside the 'Add to Cart' Button on the Product Page",
    pdpAddToCartLeft: "Left side of Add to cart button",
    pdpAddToCartRight: "Right side of Add to cart button",

    multiVariantAnnouncement: "We're excited to introduce the Multi-Variant Wishlist option! Now, your customers can wishlist specific product variants or multiple variants, giving them more flexibility and control over their selections.",
    smtpAnnouncement: "You can now configure SMTP for email reminders directly within the app! Ensure your customers never miss a notification by setting up custom email reminders with your own SMTP settings.",
    ...
    planPageMainHeading1: "Choose Plan",
    planPageMainText1: "Here you can choose any plan which fits your requirements",
    yourNameP: "Your name",
    collecionIconRedirect: "Icon/Button click behaviour",
    collecionIconRedirectSH: "Choose what to do after clicking on collection icon or button",
    redirectYes: "Redirect to product detail page",
    redirectNo: "Normal behaviour(open popup/drawer or page)",
    leranMore: "Learn more",
    availablePromoCode: "Available promo codes",
    availablePromoCodeSH: "Unlock exclusive savings by applying promo codes",
    promoPlans: "plans",
    pcAddedHeading: "Promo Code Added!",
    pcAddedSubHeading: "Your promo code:",
    promoCodeH: "Have a promo code",
    isApplied: "is applied to",
    noPCApplied: "No promo code is applied",
    pleaseEnterPc: "Please enter promo code",
    promoPlaceholder: "Enter promo code",
    promoPlan: "plan",
    apply: "Apply",
    applyNow: "Apply now",
    hideLoginTextModal: "Hide login/register text from wishlist modal,drawer and page",
    hideCounterHeaderIcon: "Hide counter of header icon and floating icon",

    cciHeading: "Custom code integration",
    cciSubHeading: "Custom code options are available for wishlist functionalities. Feel free to use them as needed.",
    enabled: "Enabled",
    disabled: "Disabled",

    admLang1: "Admin Language",
    strLang1: "Store Front Language",
    chngLang1: "Change Language",
    edtLang1: "Edit Language",
    asMenuN: "Menu item",
    asHeaderN: "Header icon",
    asFloatingN: "Floating icon",

    senderName: "Sender Name",
    senderNameSub: "Enter the sender name that will appear as the sender in the email.",
    replyToEmail: "Reply-To Email Address",
    replyToEmailSub: "Enter the email address where recipients should send their replies.",

    hideLoginText: "Hide login text from modal and drawer",
    multiVariantInstr: `If you enable the multi-variant wishlist feature, you must include the variant-id="{{ product.selected_or_first_available_variant.id }}" attribute in the code. Otherwise, you can omit the variant-id attribute.`,


    annMultiVarUpdate: "Multiple variant wishlist upgrade",
    annMultiVarUpdate2: "We've enhanced the multiple variant wishlist by adding a variant dropdown in the wishlist modal. This allows users to select a specific product variant before adding it to the cart. This feature is available under the Premium plan.",
    annPaidThemeTrial: "Compatible with Paid Themes in Trial Mode",
    annPaidThemeTrial2: "You can now use our app with paid Shopify themes even while in trial mode. This allows you to fully test the app's features before making a purchase.",
    annPagiFly: "Compatibility with PageFly App",
    annPagiFly2: "Our app is now compatible with the PageFly app. You can easily add the wishlist icon to collection pages built using PageFly.",
    annPDP: "Product Detail Page Module Upgrade",
    annPDP2: "In this module, users are given the option to place the wishlist icon next to the product title, beside the Add to Cart button, or on the product image at various positions. You can explore these settings on the Button Settings page.",
    pdpiconDash1: "On PDP image",
    pdpiconDash2: "Beside title",
    pdpiconDash3: "Beside Add to cart",
    shareToAdminWishlist: "Share wishlist to admin",
    shareToAdminWishlistSub: "Share your wishlist to the admin direct",


    annSwtO: "Share Your Wishlist with the Store Owner",
    annSwto2: "We have introduced a new feature that allows users to share their wishlist directly with the store owner for any queries or assistance. This feature is available under the Premium Plan.",
    updateSalesText: "Update sale text",
    addWishlistDescription: "Add wishlist description",
    shareWishlistTadmin: "Share wishlist to admin button text",
    hideCounter: "Hide counter of header icon and floating icon",
    headerIconPosition: "Wishlist header icon position",
    hiLeft: "Left of Cart Icon",
    hiRight: "Right of Cart Icon",


    jsAfterCartBtn: "Custom js/jQuery after add to cart button",
    jsAfterCartBtnSub: `Customize js/jQuery after add to cart button (use "" only)`,
    jsAfterCartBtnPlaceholder: "Enter here custom js/jQuery that you want to run after pressing add to cart button for your site...",
    addCustomDomain: "Add your custom domain",
    partnerPromo: "For a development store to be eligible for any plan use this promo code",
    noPromoCode: "No promo code available",

    btnType1: "Text + Background + No Icon",
    btnType2: "Only Text + No Background + No Icon",
    btnType3: "Icon + Text + Background",
    btnType4: "Icon + Text + No Background",
    btnType5: "Icon + Background + No Text",
    wmsHeading: "Styles for Wishlist Item Grids  on Modal/Page",
    wmsSubHeading: "Here you can customize the styles of the modal/page grid",
    wmsGridAlignment: "Grid content alignment",
    wmsGridBorderRadius: "Grid border radius",
    wmsGridBg: "Grid background color",
    wmsGridGap: "Grid gap",
    atcHeading: "Customise Add to cart button",
    atcText: "Update Add to cart button text",
    atcTextColor: "Text color",
    atcBgColor: "Background color",
    atcShowIcon: "Show icon",
    snHeading: "Customise Shop Now button",
    snText: "Update Shop Now button text",
    gtwHeading: "Customise Go to wishlist button",
    gtwText: "Update Go to wishlist button text",
    verifySmtpButton: "VERIFY SMTP DATA",
    monthlyEmailQuota: "Monthly Email quota",

    wmsImageRender: "Image Rendering Style",
    wmsImageDefault: "Default",
    wmsImageFitToGrid: "Image fit to grid",


    availableInPremium: " (Available in Premium plan only)",
    productOptionHeading: "Show product option in the modal, page & Drawer ",
    downloadCsv: "Allow users to download their wishlist in .CSV ",


    anna1: "Export Wishlist CSV by Users",
    anna11: "Customers can instantly download their wishlist in CSV format, making it easy to save or share their favorite items.",
    anna2: "Improved Multi-Wishlist",
    anna22: "Shoppers can now edit, copy, and delete items in just a few clicks for a seamless wishlist experience.",
    anna3: "Customisable Wishlist Layouts",
    anna33: "Merchants can use new customise tools to fully adjust fonts, colors, and layouts so the wishlist cards aligns with their store’s design.",
    anna4: "Email Module Upgrades",
    anna44: "Added custom fields for buttons, letting merchants tailor CTAs to drive more conversions.",
    anna5: "Product Options Support",
    anna55: "Works seamlessly with apps like Infinite Options, Bold, and Globo, giving customers more flexibility.",
    anna6: "Enhanced Klaviyo Integration",
    anna66: "Deeper connectivity ensures targeted campaigns and stronger customer engagement.",
    anna7: "New Theme Compatibility",
    anna77: "Fully optimised for Shopify’s newest themes, ensuring smooth performance out of the box.",

    appsByWf: "Apps by Webframez",
    pickedForBusiness: "Picked for your business",
    quoteGuruTitle: "Quotes Guru: RFQ & Hide Prices",
    quoteGuruDesc: "Advanced & Easy RFQ tool to help stores to get instant quotes",
